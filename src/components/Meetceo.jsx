  ...
  const ceocontent = [
    {
      ...
      Text: "Rasaki is the CEO of Elephant Company INC, a leading building renovation company. With over 20 years of experience in the construction industry, Makun has built a reputation for his expertise in transforming both residential and commercial properties. His hands-on approach and keen eye for detail have driven the company's success, ensuring projects are completed on time, within budget, and to the highest standards. Passionate about sustainable design and innovative solutions, John continues to lead Elephant Company with a forward-thinking mindset, prioritizing quality and client satisfaction in every renovation project.",
    },
  ];
  return (
    <div>
