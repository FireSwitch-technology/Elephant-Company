...
const Hero = () => {
  return (
    <div className="w-full h-fit bg-gray-100  flex items-center justify-center flex-col  ">
      ...
      {/* content */}
      <div className=" absolute top-56 max-w-4xl flex flex-col items-center justify-center gap-5 z-10">
        <h1 className=" text-2xl sm:text-7xl text-center font-display text-white font-bold">
          Home & Commercial Services You Can Count On
        </h1>
        <p className="  text-base sm:text-xl font-display font-normal text-white text-center w-xs sm:w-xl ">
      ...
      <div className=" -mt-20 z-10 ">
        <div className="  bg-black-100  sm:w-5xl p-8 m-auto rounded-2xl sm:grid sm:grid-cols-3 grid grid-cols-1 gap-5 text-center ">
          {/* vector1 */}
